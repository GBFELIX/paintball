          ...
          <div className="bg-white p-6 rounded-lg w-[500px]">
            ...
            <div className="mb-4">
              <p className="font-bold">
                Valor Total: R$ {despesas[despesaIndexForPayment]?.items.reduce((sum, item) => sum + item.valor, 0).toFixed(2)}
              </p>
            </div>
            ...
            <div className="mb-4">
              <select
                ...
                onChange={(e) => {
                  ...
                  const valorTotal = despesas[despesaIndexForPayment]?.items.reduce((sum, item) => sum + item.valor, 0);
